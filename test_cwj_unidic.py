                              ...
                              if token[0] == '《':
                                    ...
                                    if 12450 <= ord(parsed_txt[i][0]) <= 12538:
                                          ...
                                          if 65 <= ord(parsed_txt[i][0]) <= 122:
                                                ...
                                                if len(token_with_kanji) >= 13:
                                                      if not token_with_kanji[13] == '外':
                                                            reading = '*' + reading
...
def main():
      ...
      for filename in files:
            ...
            with open('/home/anna/DH_research_2019-20/Files_tsv_cwj/{}.tsv'.format(filename), 'w', encoding = 'utf-8') as fw:
